...
import com.cst438.SpotifyConfiguration;
import com.cst438.domain.User1;
import com.cst438.domain.UserRepository;
import com.cst438.service.UserProfileService;
...
public class SpotifyController {
	...
	private String customIp = "https://localhost:3000";
	...
	public void getSpotifyUserCode(@RequestParam("code") String userCode, HttpServletResponse response)	throws IOException {
		...
		se.michaelthelin.spotify.model_objects.specification.User user = null;
	...
	public SavedAlbum[] getCurrentUserSavedAlbum(@RequestParam String userId) {
		com.cst438.domain.User1 userDetails = userRepository.findById(userId);
